...
/* window.c */
void make_window8(unsigned char *buf, int xsize, int ysize, unsigned char *title, char act);
void putfonts8_asc_sht(struct SHEET *sht, int x, int y, int c, int b, unsigned char *s, int l);
void make_textbox8(struct SHEET *sht, int x0, int y0, int sx, int sy, int c);
void make_wtitle8(unsigned char *buf, int xsize, unsigned char *title, char act);
