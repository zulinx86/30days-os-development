...
void HariMain(void)
{
	...
	char *buf_back, buf_mouse[256], *buf_win, *buf_win_b;
	...
	mysprintf(s, "VRAM: 0x%04x%04x", (int)((unsigned int)binfo->vram >> 16), (int)(0xffff & (unsigned int)binfo->vram));
	putfonts8_asc_sht(sht_back, 12 * 8, 0, COL8_FFFFFF, COL8_008484, s, 16);
